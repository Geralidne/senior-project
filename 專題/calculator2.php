...
<hr>
    ...
    <main>
        <section class="container">
            <h1 class="text-center mb-5">計算化妝品碳排</h1>
            <form>
                <div class="form-group">
                    <label for="product-type">產品種類</label>
                    <select class="form-control" id="product-type" name="product-type">
                        <option value="makeup1">化妝品1</option>
                        <option value="makeup2">化妝品2</option>
                        <option value="makeup3">化妝品3</option>
                        <option value="makeup4">化妝品4</option>
                    </select>
                </div>
